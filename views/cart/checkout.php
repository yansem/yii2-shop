            ...
            <?php if (!empty($session['cart'])): ?>
                            ...
                            foreach ($session['cart'] as $id => $item): ?>
                                <tr class="rem1">
                                    ...
                                    <td class="invert-image"><a
                                                href="<?= \yii\helpers\Url::to(['product/view', 'id' => $id])
                                                ?>"><?= \yii\helpers\Html::img("@web/products/{$item['img']}", ['alt' =>
                                                $item['title']]) ?></a></td>
                                    <td class="invert">
                                        <div class="quantity">
                                            <div class="quantity-select">
                                                <div class="entry value-minus" data-id="<?= $id ?>" data-qty="-1">&nbsp;
                                                </div>
                                    ...
                                    <td class="invert">
                                        <div class="rem">
                                            <a href="<?= \yii\helpers\Url::to(['cart/del-item', 'id' => $id]) ?>"
                                               class="close1"></a>
                                        </div>
                ...
                <div class="checkout-left">
                    ...
                    <div class="col-md-8 address_form_agile">
                        ...
                        <?= $form->field($order, 'note')->textarea(['rows' => 4]) ?>
